INSERT INTO `user` VALUES (1,'manu','manu','manu','tarrou','emmanuel.tarrou34@gmail.com','Montpellier','ADMIN'),(2,'marcel','marcel','marcel','lavigne','test@test.fr','Montpellier','USER');


INSERT INTO `user_settings` VALUES (1,'fr_FR',1,1,1,1,1),(2,'fr_FR',1,0,0,1,2);
